...
public static String testInput3 = // 8 
"""
7-F7-
.FJ|7
SJLL7
...
*/
//	public static String input = testInput3;
...
//		printPipeplan(pipeplan);
		...
		if (c == '|' || c == 'F' || c == '7')
		{
			...
			ArrayList<XYPoint> t = travel(startPoint,startPoint.x,startPoint.y - 1,EcurrentDirection.north, pipeplan);
		...
		if (c == '|' || c == 'L' || c == 'J')
		{
			...
			ArrayList<XYPoint> t = travel(startPoint,startPoint.x,startPoint.y + 1,EcurrentDirection.south, pipeplan);
			System.out.println(t);
		}
		...
		for(XYPoint p : twest)
		{
			int i = teast.indexOf(p);
			int j = twest.indexOf(p);
			if (i != -1)
			{
